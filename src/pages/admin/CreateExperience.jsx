...
import { Plus, CheckCircle, Upload, Check, X, Loader2 } from 'lucide-react';
...
import { localToUTC, getUserTimezone } from '../../utils/timezoneHelper';
...
const AdminCreateExperience = () => {
      ...
      const resetTimeout = () => {
        ...
        progressTimeout = setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            resetFormData();
            navigate(`/admin/experience-created/${experienceId}`);
          }, 1500);
        }, 3000);
      };
  ...
  const isSaveEnabled = experienceData.stages.length > 0 && isSessionSettingsFilled();
...
export default AdminCreateExperience;
