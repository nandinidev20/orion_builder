...
import ToggleButton from '../studio/CreateExperiencV2/ToggleButton';
import ExperienceFlow from '../studio/CreateExperiencV2/ExperienceFlow';
import StageEditor from '../studio/CreateExperiencV2/StageEditor';
import SessionSettings from '../studio/CreateExperiencV2/SessionSettings';
import StylesEditor from '../studio/CreateExperiencV2/StylesEditor';
import Settings from '../studio/CreateExperiencV2/Settings';
...
const AdminEditExperience = () => {
    ...
    const fetchExperienceData = async () => {
      try {
        ...
        const getAssetUrl = (path) => {
          ...
          const baseUrl = import.meta.env.VITE_ASSET_BASE_URL || 'http://localhost:5000';
  ...
  // Helper function to format date/time - backend will combine them
  // Keep dates as-is since backend's processExperienceDates will handle combining them
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">
                {uploadStatus === 'success' ? '✨ All Done!' :
                 ...
                 uploadStatus === 'processing' ? 'Processing Files...' :
                 'Uploading Files...'}
              </h3>
            ...
            <p className="text-sm text-gray-600">
              {uploadStatus === 'success' ? 'Your experience has been updated successfully!' :
               ...
               uploadStatus === 'processing' ? 'Your files are being processed. This may take a few minutes for large videos. Please keep this window open...' :
